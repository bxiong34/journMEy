...
export default function Footer() {
  ...
  return (
    <footer className='border-t w-full flex flex-row justify-between bg-[#1a1a1a]/90 text-zinc-100 p-3 text-center'>
      <div></div>
      <div>
        <a href="https://github.com/bxiong34/journMEy" target="_blank" rel="noopener noreferrer">
          <FaGithub size={30} />
        </a>
      </div>
      <div>
        <button className='border rounded-md p-1' onClick={handleDonateClick}>Donate</button>
      </div>
    </footer>
  )
}