    ...
    <div className='map-area'>
      ...
      {/* container for list of cities and reviews */}
        ...
        {cities.map((city, index) => (
            <div key={index} className='border rounded-2xl w-10/12 flex flex-row justify-around items-center mt-2'>
              <div className='flex flex-row w-3/12'>
                <img src={city.ProfilePic} alt={city.Name} className='w-20 h-20  rounded-2xl' />
